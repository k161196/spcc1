...
/*
code@code-Aspire-A515-51G:~/Pictures/code$ javac FirstandFollow.java
code@code-Aspire-A515-51G:~/Pictures/code$ java FirstandFollow
Enter the Non Terminals
SBC
Enter the Terminals
bace
Specify the grammar(Enter < for epsilon production)
...
e
-------------------------------------------
First Set of S is {aec}
First Set of B is {ae}
First Set of C is {ce}
-------------------------------------------
Follow Set of S is {$}
Follow Set of B is {b}
Follow Set of C is {d}
*/