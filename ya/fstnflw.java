...
for(i=0;i<ntlen;i++)
System.out.println("First Set of " +nt.charAt(i)+" is {"+removeDuplicates(fst[i])+"}");
...
{
if(pro[l]==ntermnl[i])
//finding the nonterminal whose follow set is to befound
{
if(l==pro.length-1)
//if it is the last terminal/non-terminal then follow of currentnon-terminal
{
if(j<i)
temp=temp+flw[j];
}
